...
export class GridcreditcardszerobalController {
  constructor(
    @inject('datasources.oracle') public dataSource: OracleDataSource
  ) {}

  //gridcreditcardszerobal
  @post('/nodeapi/gridcreditcardszerobal/viewall', {
    responses: {
      '200': spec,
    },
  })
  async gridcreditcardszerobal
  ...
  buildSql(request: any) {
    ...
    var fromSql = " from qcards where OUTBALANCE in (0,-1) and primary = \'P\' ";
