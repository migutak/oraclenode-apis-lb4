...
export class GriddueforrelegationController {
  constructor(
    @inject('datasources.oracle') public dataSource: OracleDataSource
  ) {}

  //griddueforrelegation
  @post('/nodeapi/griddueforrelegation/viewall', {
    responses: {
      '200': spec,
    },
  })
  ...
  buildSql(request: any) {
    ...
    var fromSql = " from tqall where daysinarr > 90 and RROCODE = 'RRO00'";
